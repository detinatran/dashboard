...
function getAppearance() {
  ...
  return isDark
    ? {
        layout,
        variables: {
          colorBackground: '#0b100d',
          colorInputBackground: '#0b100d',
          colorInput: '#0b100d',
          colorInputText: '#c8d6cd',
          colorInputForeground: '#c8d6cd',
          colorText: '#c8d6cd',
          colorForeground: '#c8d6cd',
          colorTextSecondary: '#7f9689',
          colorMutedForeground: '#7f9689',
          colorPrimary: '#7df9c0',
        ...
        elements: {
          card: { backgroundColor: '#0b100d', border: '1px solid #2a2a2a', boxShadow: '0 8px 32px rgba(0,0,0,0.6)' },
          headerTitle: { color: '#c8d6cd' },
          headerSubtitle: { color: '#7f9689' },
          dividerLine: { backgroundColor: '#16211a' },
          dividerText: { color: '#54635a' },
          formButtonPrimary: { color: '#000000', fontWeight: '600' },
          footerActionLink: { color: '#7df9c0' },
          identityPreviewEditButton: { color: '#7df9c0' },
          formFieldLabel: { color: '#c8d6cd' },
          formFieldInput: { borderColor: '#16211a' },
          socialButtonsBlockButton: { borderColor: '#16211a', color: '#c8d6cd', backgroundColor: '#0b100d' },
          socialButtonsBlockButtonText: { color: '#c8d6cd' },
          modalCloseButton: { color: '#7f9689' },
        },
      }
    : {
        layout,
