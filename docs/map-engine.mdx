...
Country boundaries, bundled boundary overrides, and the geocoding service are documented in [Maps & Geocoding](/maps-and-geocoding). Optional self-hosted PMTiles archives can be configured separately.
